...
export default function About(props) {
    let myStyle = {
        backgroundColor: props.mode === 'dark' ? 'rgb(22 25 61)' : 'white',
         color: props.mode === 'dark' ? 'white' : 'rgb(22 25 61)'
    }
    return (
        <div className="accordion accordion-flush" id="accordionFlushExample">
            <h2 className='my-3' style={{color: props.mode === 'dark' ? 'white' : 'rgb(22 25 61)'}}>About Us</h2>
            ...
            <div className="accordion-item" style={myStyle}>
                <h2 className="accordion-header" id="flush-headingTwo">
                    <button className="accordion-button btn btn-light collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo" style={myStyle}>
                        Accordion Item #2
                    </button>
                </h2>
